...
![Màn hình đăng nhập IRMS](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-06.png)

Sau khi đăng nhập, kiểm tra dashboard hiển thị các thẻ trạng thái incident, recent incidents và security posture.

![Dashboard IRMS](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-07.png)
...
![Tạo incident mới](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-09.png)

Submit form và kiểm tra incident vừa tạo xuất hiện trong danh sách.

![Tạo incident thành công](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-10.png)

Mở trang chi tiết incident và kiểm tra status, severity, assignee, timeline và evidence panel.

![Chi tiết incident](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-11.png)

Thêm một timeline entry cho giai đoạn investigating hoặc containment.

![Thêm timeline entry](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-12.png)

![Timeline entry đã lưu](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-13.png)
...
![Form upload evidence](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-14.png)

Frontend tự nhận diện tên file, MIME type và dung lượng file trước khi upload.

![Thông tin evidence](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-15.png)

Nhấn submit evidence. Browser upload file trực tiếp lên Amazon S3 bằng presigned PUT URL có thời hạn ngắn.

![Submit evidence](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-16.png)

Xác minh object vừa upload trong private S3 evidence bucket.

![Evidence object trong S3](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-17.png)

Xác minh metadata tương ứng trong DynamoDB.

![Evidence metadata trong DynamoDB](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-18.png)
...
![Trang AI Assistant](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-19.png)

Chọn incident vừa tạo để phân tích.

![Chọn incident cho AI analysis](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-20.png)

Xem kết quả phân tích có cấu trúc.

![Kết quả AI Analyst](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-21.png)

Kết quả AI tóm tắt impact, mức ưu tiên phản hồi, đề xuất xử lý và ngữ cảnh hỗ trợ.

![AI findings](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-22.png)
...
![Chế độ AI Chat](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-24.png)
...
![Phản hồi AI Chat](/internship01/images/5-Workshop/IRMS-demo-test/demo-test-25.png)

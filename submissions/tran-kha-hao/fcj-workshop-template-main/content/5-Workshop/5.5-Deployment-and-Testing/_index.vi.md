...
Kết quả mong đợi:
Type: AWS::Serverless::Api
![API Gateway Production 1](/internship01/images/5-Workshop/IRMS/section-08-001.png)
**Bước 3: Kiểm tra route /incidents:**
findstr /C:"/incidents" infrastructure\template.yaml
Kết quả mong đợi có các route:
Path: /incidents
Path: /incidents/{id}
![API Gateway Production 2](/internship01/images/5-Workshop/IRMS/section-08-002.png)
**Bước 4: Kiểm tra route /evidence:**
findstr /C:"/evidence" infrastructure\template.yaml
Kết quả mong đợi:
Path: /evidence
Path: /evidence/{id}
![API Gateway Production 3](/internship01/images/5-Workshop/IRMS/section-08-003.png)
...
Path: /ai/explain
Path: /ai/chat
![API Gateway Production 4](/internship01/images/5-Workshop/IRMS/section-08-004.png)
...
![API Gateway Production 5](/internship01/images/5-Workshop/IRMS/section-08-005.png)
...
CognitoAuthorizer
UserPoolArn
![API Gateway Production 6](/internship01/images/5-Workshop/IRMS/section-08-006.png)
...
![API Gateway Production 7](/internship01/images/5-Workshop/IRMS/section-08-007.png)
...
![EventBridge & GuardDuty 1](/internship01/images/5-Workshop/IRMS/section-09-001.png)
...
![EventBridge & GuardDuty 2](/internship01/images/5-Workshop/IRMS/section-09-002.png)
...
![EventBridge & GuardDuty 3](/internship01/images/5-Workshop/IRMS/section-09-003.png)
**Bước 5: Kiểm tra SNS topic:**
findstr /C:"TopicName" infrastructure\template.yaml
![EventBridge & GuardDuty 4](/internship01/images/5-Workshop/IRMS/section-09-004.png)
findstr /C:"SNS" infrastructure\template.yaml
![EventBridge & GuardDuty 5](/internship01/images/5-Workshop/IRMS/section-09-005.png)
**Bước 6: Kiểm tra quyền SNS publish:**
findstr /C:"SNS" infrastructure\template.yaml
![EventBridge & GuardDuty 6](/internship01/images/5-Workshop/IRMS/section-09-006.png)
...
![EventBridge & GuardDuty 7](/internship01/images/5-Workshop/IRMS/section-09-007.png)
**Bước 8: Validate SAM template:**
sam validate --template-file infrastructure\template.yaml --region ap-southeast-1
Kết quả mong đợi:
D:\Thực Tập\irms-serverless\infrastructure\template.yaml is a valid SAM Template.
...
- sinh thư mục
.aws-sam
![Build & Deploy 1](/internship01/images/5-Workshop/IRMS/section-10-001.png)
...
AiAssistantFunction
template.yaml
![Build & Deploy 2](/internship01/images/5-Workshop/IRMS/section-10-002.png)
...
Sau lần đầu sẽ sinh
samconfig.toml
![Build & Deploy 3](/internship01/images/5-Workshop/IRMS/section-10-003.png)
...
--profile irms-shared
![Build & Deploy 4](/internship01/images/5-Workshop/IRMS/section-10-004.png)
Kiểm tra Lambda
aws lambda list-functions ^
--profile irms-shared
![Build & Deploy 5](/internship01/images/5-Workshop/IRMS/section-10-005.png)
![Build & Deploy 6](/internship01/images/5-Workshop/IRMS/section-10-006.png)
![Build & Deploy 7](/internship01/images/5-Workshop/IRMS/section-10-007.png)
Kiểm tra API
...
![Testing & Validation 1](/internship01/images/5-Workshop/IRMS/section-11-001.png)
...
--region ap-southeast-1 ^
--profile irms-shared
![Testing & Validation 2](/internship01/images/5-Workshop/IRMS/section-11-002.png)
![Testing & Validation 3](/internship01/images/5-Workshop/IRMS/section-11-003.png)
![Testing & Validation 4](/internship01/images/5-Workshop/IRMS/section-11-004.png)
![Testing & Validation 5](/internship01/images/5-Workshop/IRMS/section-11-005.png)
...
![Testing & Validation 6](/internship01/images/5-Workshop/IRMS/section-11-006.png)
Hoặc mở trình duyệt:
https://07frck8bih.execute-api.ap-southeast-1.amazonaws.com/dev/ping
![Testing & Validation 7](/internship01/images/5-Workshop/IRMS/section-11-007.png)
...
![Testing & Validation 8](/internship01/images/5-Workshop/IRMS/section-11-008.png)
...
![Testing & Validation 9](/internship01/images/5-Workshop/IRMS/section-11-009.png)
...
"IDToken": "eyJ..."
![Testing & Validation 10](/internship01/images/5-Workshop/IRMS/section-11-010.png)
...
-d "{\"title\":\"Unauthorized SSH Login\",\"description\":\"Multiple failed SSH login attempts detected\",\"severity\":\"High\",\"source\":\"manual\",\"assignedTo\":\"Security Analyst\"}"
![Testing & Validation 11](/internship01/images/5-Workshop/IRMS/section-11-011.png)
...
Danh sách Incident.
![Testing & Validation 12](/internship01/images/5-Workshop/IRMS/section-11-012.png)
...
-H "Authorization: Bearer YOUR_ID_TOKEN"
![Testing & Validation 13](/internship01/images/5-Workshop/IRMS/section-11-013.png)
...
thành:
In Progress
![Testing & Validation 14](/internship01/images/5-Workshop/IRMS/section-11-014.png)
**Bước 7: GET timeline**
...
incident.created
incident.updated
![Testing & Validation 15](/internship01/images/5-Workshop/IRMS/section-11-015.png)
**Bước 8: Kiểm tra DynamoDB**
Vào AWS Console:
DynamoDB → Tables → irms-incidents → Explore table items
Tìm :INC-53DB6458
![Testing & Validation 16](/internship01/images/5-Workshop/IRMS/section-11-016.png)
Sau đó kiểm tra timeline:
DynamoDB → Tables → irms-timeline → Explore table items
Tìm các item có:
incidentId = INC-53DB6458
![Testing & Validation 17](/internship01/images/5-Workshop/IRMS/section-11-017.png)
...
![Testing & Validation 18](/internship01/images/5-Workshop/IRMS/section-11-018.png)
![Testing & Validation 19](/internship01/images/5-Workshop/IRMS/section-11-019.png)
![Testing & Validation 20](/internship01/images/5-Workshop/IRMS/section-11-020.png)
Chức năng
...
![Testing & Validation 21](/internship01/images/5-Workshop/IRMS/section-11-021.png)
...
API trả về:
![Testing & Validation 22](/internship01/images/5-Workshop/IRMS/section-11-022.png)
...
![Testing & Validation 23](/internship01/images/5-Workshop/IRMS/section-11-023.png)
...
-H "Authorization: Bearer YOUR_ID_TOKEN"
![Testing & Validation 24](/internship01/images/5-Workshop/IRMS/section-11-024.png)
...
![Testing & Validation 25](/internship01/images/5-Workshop/IRMS/section-11-025.png)
![Testing & Validation 26](/internship01/images/5-Workshop/IRMS/section-11-026.png)
...
![Testing & Validation 28](/internship01/images/5-Workshop/IRMS/section-11-028.png)
...
![Testing & Validation 29](/internship01/images/5-Workshop/IRMS/section-11-029.png)
...
![Testing & Validation 30](/internship01/images/5-Workshop/IRMS/section-11-030.png)
...
--region ap-southeast-1 ^
--profile irms-shared
![Testing & Validation 31](/internship01/images/5-Workshop/IRMS/section-11-031.png)
**Bước 3: Kiểm tra Incident tự động**
curl.exe ^
https://07frck8bih.execute-api.ap-southeast-1.amazonaws.com/dev/incidents ^
-H "Authorization: Bearer YOUR_ID_TOKEN"
Tìm incident: Simulated SSH Brute Force Attack
![Testing & Validation 32](/internship01/images/5-Workshop/IRMS/section-11-032.png)
...
![Testing & Validation 33](/internship01/images/5-Workshop/IRMS/section-11-033.png)
**Bước 6: Kiểm tra CloudWatch**
aws logs describe-log-groups ^
--log-group-name-prefix /aws/lambda/alert-handler ^
--region ap-southeast-1 ^
--profile irms-shared
![Testing & Validation 34](/internship01/images/5-Workshop/IRMS/section-11-034.png)
...
![Testing & Validation 35](/internship01/images/5-Workshop/IRMS/section-11-035.png)
aws lambda list-functions ^
--region ap-southeast-1 ^
--profile irms-shared ^
--query "Functions[].FunctionName"
![Testing & Validation 36](/internship01/images/5-Workshop/IRMS/section-11-036.png)
aws dynamodb list-tables ^
--region ap-southeast-1 ^
--profile irms-shared
![Testing & Validation 37](/internship01/images/5-Workshop/IRMS/section-11-037.png)
aws s3 ls ^
--profile irms-shared
![Testing & Validation 38](/internship01/images/5-Workshop/IRMS/section-11-038.png)
aws events list-rules ^
--region ap-southeast-1 ^
--profile irms-shared
![Testing & Validation 39](/internship01/images/5-Workshop/IRMS/section-11-039.png)
